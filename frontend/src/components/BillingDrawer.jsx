      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            exit={{ x: "100%" }}
            transition={{ duration: 0.25 }}
            className="fixed right-0 top-0 z-50 h-screen w-full sm:w-[380px] max-w-full bg-[#0f1117] border-l border-white/10 shadow-2xl flex flex-col"
          >
            <div className="flex items-center justify-between p-4 sm:p-5 border-b border-white/10">
              ...
              <button
                onClick={onClose}
                className="w-9 h-9 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center shrink-0"
              >
                <X size={18} className="text-slate-300" />
              </button>
            </div>
              ...
              <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
                <div className="flex justify-between items-center">
                  <div className="min-w-0">
                    ...
                    <h3 className="text-white text-xl font-bold capitalize truncate">
                      {userData?.plan || "free"}
                    </h3>
                  </div>

                  <Crown className="text-yellow-400 shrink-0" />
                </div>
            ...
            <div className="px-4 sm:px-5 pb-5 flex-1 overflow-y-auto space-y-4">
              <div className="rounded-xl border border-white/10 p-4">
                ...
                <button
                  className="mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2.5 text-white transition"
                  onClick={() => handleUpgrade("starter")}
                >
                  Upgrade
                </button>
